...
### Tests for User Story 1 (REQUIRED for mechanism code — see Constitution Principle III) ⚠️
...
### Tests for User Story 2 (REQUIRED for mechanism code — see Constitution Principle III) ⚠️
...
### Tests for User Story 3 (REQUIRED for mechanism code — see Constitution Principle III) ⚠️
...
- Tests MUST be written and FAIL before implementation (mandatory for mechanism code)
